...
from app.services.treatment_service import get_treatment_by_disease, get_all_diseases
from app.services.firebase_service import save_prediction_to_firebase, get_user_prediction_history
