...
class QualityTheme {
  ...
  static Color bgColor(String quality) {
    switch (quality) {
      case 'high_quality':
        return AppColors.highGreenLight;
      case 'medium_quality':
        return AppColors.medAmberLight;
      default:
        return AppColors.lowRedLight;
    }
  }
  ...
  static Color fgColor(String quality) {
    switch (quality) {
      case 'high_quality':
        return AppColors.highGreen;
      case 'medium_quality':
        return AppColors.medAmber;
      default:
        return AppColors.lowRed;
    }
  }
...
class AppDecorations {
  ...
  static BoxDecoration glassCard({Color? border}) => BoxDecoration(
    ...
    border: Border.all(
      color: border ?? AppColors.blush.withOpacity(0.6),
      width: 1.2,
    ),
    boxShadow: [
      BoxShadow(
